...
<div class="row">
    <div class="col mb-4">
        ...
        @if ($domisili->pengajuan->status == 0 || $domisili->pengajuan->status == 3)
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    @if ($domisili->pengajuan->scan_ktp)
                        <a href="{{ url('storage/'.$domisili->pengajuan->scan_ktp) }}" class="btn btn-sm btn-outline-secondary" target="_blank" rel="noopener noreferer">
                            Lihat KTP
                        </a>
                    @else
                        <i>Tidak ada KTP</i>
                ...
                <div class="form-group">
                    ...
                    @if ($domisili->pengajuan->scan_kk)
                        <a href="{{ url('storage/'.$domisili->pengajuan->scan_kk) }}" class="btn btn-sm btn-outline-secondary" target="_blank" rel="noopener noreferer">
                            Lihat KK
                        </a>
                    @else
                        <i>Tidak ada KK</i>
                ...
                <div class="form-group">
                    ...
                    @if ($domisili->pengajuan->scan_akta)
                        <a href="{{ url('storage/'.$domisili->pengajuan->scan_akta) }}" class="btn btn-sm btn-outline-secondary" target="_blank" rel="noopener noreferer">
