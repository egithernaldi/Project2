...
<div class="row">
    ...
    <div class="col-lg-6">
        <div class="card">
            <div class="card-header">
                <h3 class="m-0">Data Pengajuan</h3>
            </div>
            <div class="card-body">
                <form action="{{ route('domisili-store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="domisili" name="domisili" required></textarea>
                    </div>

                    <div class="form-group">
                        <label for="keperluan">Keperluan <span class="text-danger">*</span></label>
                        <textarea class="form-control" id="keperluan" name="tujuan" required></textarea>
                    </div>

                    <div class="form-group">
                        <label for="ktp">Scan KTP <span class="text-danger">*</span></label>
                        <input type="file" name="ktp" id="ktp" class="form-control" placeholder="Pilih Berkas" required>
                    </div>

                    <div class="form-group">
                        <label for="kk">Scan KK <span class="text-danger">*</span></label>
                        <input type="file" name="kk" id="kk" class="form-control" placeholder="Pilih Berkas" required>
                    </div>

                    <div class="form-group">
                        <label for="akta-kelahiran">Scan Akta Kelahiran <span class="text-danger">*</span></label>
                        <input type="file" name="akta-kelahiran" id="akta-kelahiran" class="form-control" placeholder="Pilih Berkas" required>
                    </div>
