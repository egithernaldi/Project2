...
<div id="header">
    ...
    <div class="content">
        <p>Yang  bertanda tangan di bawah ini  Wali Nagari Sungai Buluah Selatan Kecamatan Batang Anai Kabupaten Padang Pariaman : </p>
    ...
    <table class="signature">
        <tr>
          ...
          <td class="right">
            ...
            <p style="margin-top: 10px ">A R M U Z A N, SST </p>
          </td>
        </tr>
      </table>
